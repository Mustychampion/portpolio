...
export function SkillsSection({ skills = [] }: SkillsSectionProps) {
  ...
  const defaultSkills: Skill[] = [
    { id: "1", name: "Cost Estimation", description: "Prepare accurate budgets and cost plans for construction projects.", category: "QS" },
    { id: "2", name: "Contract Administration", description: "Manage contract documentation, progress claims, and variations.", category: "QS" },
    { id: "3", name: "Value Engineering", description: "Optimize project costs without compromising quality or function.", category: "QS" },
    { id: "4", name: "Data Analytics", description: "Turn raw project and operational data into actionable insights.", category: "Data & Analysis" },
    { id: "5", name: "Marketing Strategy", description: "Design measurable strategies to grow digital presence.", category: "Marketing" },
    { id: "6", name: "Small Business Consulting", description: "Practical consulting to optimize operations for SMEs.", category: "Consulting" },
    { id: "7", name: "React & TypeScript", description: "Building modern, responsive web applications.", category: "Web" },
    { id: "8", name: "Supabase", description: "Backend-as-a-Service integration for scalable apps.", category: "Web" }
  ];
